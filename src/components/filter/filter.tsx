...
import { pokemonsFilterSelector, cleanFilterPokemonsByName, filterPokemonsByName } from "../../redux/pokemons";

import { FilterContainer, Input, CleanFilter } from "./filter.styled"

const Filter = () => {
  const dispatch = useDispatch();
  const handleCleanFilter = () => dispatch(cleanFilterPokemonsByName())
